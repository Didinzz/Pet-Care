...
@section('content')
    ...
    <div class="section-body">
        <h4 class="text-dark">Edit Hewan Peliharaan</h4>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form class="needs-validation" novalidate method="POST"
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jenis_hewan" required
                                            value="{{ old('jenis_hewan', $pet->jenis_hewan) }}">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" name="jenis_kelamin" required>
                                            ...
                                            <option value="Jantan"
                                                ...
                                                Jantan</option>
                                            <option value="Betina"
                                                {{ old('jenis_kelamin', $pet->jenis_kelamin) == 'Betina' ? 'selected' : '' }}>
                                                Betina</option>
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" name="status_vaksinasi" required>
                                            ...
                                            <option value="Lengkap"
                                                {{ old('status_vaksinasi', $pet->status_vaksinasi) == 'Lengkap' ? 'selected' : '' }}>
                                                Lengkap</option>
                                            <option value="Perlu Booster"
                                                {{ old('status_vaksinasi', $pet->status_vaksinasi) == 'Perlu Booster' ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan_khusus" rows="3" required>{{ old('catatan_khusus', $pet->catatan_khusus) }}</textarea>
                                <div class="invalid-feedback">
                                    Catatan tidak valid
                                </div>
