...
@section('content')
    ...
    <div class="section-body">
        <h4 class="text-dark">Tambah Riwayat Kunjungan</h4>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('riwayat.store') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-6">
                                        ...
                                        <select class="form-control selectric" name="dokter_id" required>
                                            ...
                                            @foreach ($dokters as $dokter)
                                                <option value="{{ $dokter->id }}"
                                                    ...
                                                    {{ $dokter->name }} - {{ $dokter->jadwalPraktik->formatted_jadwal }} -
                                                    {{ $dokter->jadwalPraktik->formatted_jam }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6" id="tanggalKunjungan">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepicker" name="tanggal_kunjungan"
                                            required value="{{ old('tanggal_kunjungan') }}">
                                        <div class="invalid-feedback">
                                        ...
                                        <select class="form-control selectric" name="jenis_layanan">
                                            ...
                                            @foreach ($jenisLayanan as $layanan)
                                                <option value="{{ $layanan }}"
                                                    {{ old('jenis_layanan') == $layanan ? 'selected' : '' }}>
                                                    {{ $layanan }}
                                                </option>
                                            @endforeach
                                        </select>
